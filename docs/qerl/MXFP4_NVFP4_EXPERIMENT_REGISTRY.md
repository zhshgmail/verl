...
| Order | Experiment | Config | Result | vs Baseline | Purpose |
|-------|------------|--------|--------|-------------|---------|
| 1 | **E7a** | BF16 + LoRA | **71.27%** ✅ | BASELINE | Pure LoRA baseline |
| 2 | **E6a** | MXFP4 + LoRA | **65.88%** ✅ | **-5.39%** | Quantization impact |
| 3 | **E6b** | MXFP4 + LoRA + AQN | 🔄 RUNNING | ? | AQN recovery |
