...
class PartialRolloutManager(AgentLoopManager):
    ...
    def generate_sequences(self, prompts: DataProto, **sampling_params) -> DataProto:
        """
        Generate sequences with version tracking.

        This method wraps parent's generate_sequences() to add version tracking.
        No chunked generation - just annotate outputs with policy version.
        ...
        Returns:
            DataProto with generated sequences, annotated with version info
        """
        ...
        # Add version tracking to non_tensor_batch
