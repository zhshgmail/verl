#!/bin/bash
# Test 4a: Mild AQN (σ=0.025, half of QeRL's σ=0.05)
# Testing weaker noise injection to find optimal balance
...
python3 -u -m verl.trainer.main_ppo \
    ...
    trainer.project_name=verl_qerl_test4a \
    trainer.experiment_name=qwen25_15b_mild_aqn \
    ...
    trainer.noise_injection.sigma_start=0.025 \
    trainer.noise_injection.sigma_end=0.00025 \
