...
# E7A Experiment: Qwen3-30B WITHOUT Error Injection (Baseline)
...
exp_name='E7A-Qwen3-30B-GSM8K-no-error-injection'
...
# DISABLE Error injection for E7A (baseline experiment)
# NO error injection parameters set
# NO VERL_NOISY_OPS_ENABLED environment variable
