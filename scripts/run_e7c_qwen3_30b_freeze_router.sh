#!/bin/bash
set -x
export RAY_TMPDIR=/data1/tmp

# E7C Experiment: Qwen3-30B with Error Injection and AQN
# Based on run_qwen3moe-30b_megatron_96gb.sh

NNODES=${NNODES:-1}
NGPUS_PER_NODES=${NGPUS_PER_NODES:-8}

project_name='moe_aqn'
exp_name='E7C-Qwen3-30B-GSM8K-5percent-linear-error-injection-aqn-freeze-router'
...
# Model and Data Paths - Using specified paths
MODEL_PATH=/data1/Qwen3-30B-A3B-Base
TRAIN_FILE=/data1/gsm8k/train.parquet
TEST_FILE=/data1/gsm8k/test.parquet
...
# Error injection parameters (E7 configuration)
ERROR_SCALE=5e-2
ERROR_TYPE=relative_gaussian

# Enable noisy ops via environment variables
export VERL_NOISY_OPS_ENABLED=1
export VERL_NOISY_OPS_SCALE=${ERROR_SCALE}
export VERL_NOISY_OPS_TYPE=${ERROR_TYPE}

# WANDB configuration
export WANDB_API_KEY=cd9157a17f7688b184e27918bc2809f47f9a2993
export WANDB_ENTITY=vaai
export WANDB_PROJECT=moe_aqn
export TENSORBOARD_DIR=/data1/verl/tensorboard_log/${project_name}/${exp_name}

echo "====================================="
echo "Starting E7C Experiment (with AQN)"
echo "Model: ${MODEL_PATH}"
echo "Train Data: ${TRAIN_FILE}"
echo "Test Data: ${TEST_FILE}"
echo "Error Injection: ${ERROR_SCALE} (${ERROR_TYPE})"
echo "AQN: Enabled"
echo "====================================="
...
python3 -m verl.trainer.main_ppo --config-path=./config --config-name='ppo_megatron_trainer' \
    ...
    trainer.default_local_dir=/data1/verl/checkpoints \
    trainer.default_hdfs_dir=null \
    +trainer.logger_cfgs.tensorboard.save_dir=/data1/verl/tensorboard_log \
