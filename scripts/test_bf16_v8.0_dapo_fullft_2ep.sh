#!/bin/bash
# BF16 v8.0: DAPO Full Fine-Tuning Baseline (2 epochs)
#
# Experiment ID: E8a
# Date: 2026-01-12
#
...
OUTPUT_DIR="/tmp/bf16_v8.0_dapo_fullft_2ep"
mkdir -p ${OUTPUT_DIR}
...
python3 -m recipe.dapo.main_dapo \
    ...
    trainer.experiment_name=bf16_v8.0_dapo_fullft_2ep \
