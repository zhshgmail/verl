#!/bin/bash
# MXFP4 v3.0: DAPO with overlong penalty (2 epochs)
#
...
OUTPUT_DIR="/tmp/mxfp4_v3.0_dapo_2ep"
mkdir -p ${OUTPUT_DIR}
...
python3 -m recipe.dapo.main_dapo \
    ...
    trainer.experiment_name=mxfp4_v3.0_dapo_2ep \
