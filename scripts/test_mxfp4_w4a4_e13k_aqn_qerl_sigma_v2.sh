...
OUTPUT_DIR="/tmp/mxfp4_w4a4_e13k_v2_aqn_qerl_sigma"
mkdir -p ${OUTPUT_DIR}
...
python3 -m recipe.dapo.main_dapo \
    ...
    trainer.project_name=w4a4_e13k_v2_aqn_qerl_sigma \
    trainer.experiment_name=e13k_v2_mxfp4_w4a4_aqn_sigma0.01_1ep \
